...
pub enum CorrectionType {
    ...
    SplitCombined = 0,
    /// A mixed depth texture / sampler has been split, insert the same object again with a `Regular` bind type.
    SplitDrefRegular = 1,
    /// A mixed depth texture / sampler has been split, insert the same object again with a
